...
export function getCachedConfig() {
  if (typeof window === 'undefined') {
    ...
    const envVoting = process.env.VOTING_CONTRACT_ADDRESS || process.env.NEXT_PUBLIC_VOTING_CONTRACT_ADDRESS || '8ac29e39f6ac3de1dd63db8b9d9c5eed8efd407e900901987b32418e9f51457e';
    const envDni = process.env.DNI_CONTRACT_ADDRESS || process.env.NEXT_PUBLIC_DNI_CONTRACT_ADDRESS || '0a397d25eb5779f68fb3685756006d332077185d956bd652d248b00519c8ba10';
